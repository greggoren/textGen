...
import torch
from model.Seq2SeqNet import Seq2seq
...
def train_model(lr,batch_size,epochs,hidden_size,n_layers,w2v_model,SOS_idx,EOS_idx,PAD_idx,data_set_file_path,random_seed,p,bidirectional,logger=None):
    #t
    prnt = False
    ...
    net = Seq2seq(cols,rows+3,hidden_size,SOS_idx,EOS_idx,PAD_idx,n_layers,w2v_model.wv.vectors,criterion,random_seed,p,device,bidirectional)

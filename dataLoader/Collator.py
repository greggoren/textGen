...
class PadCollator(object):
    ...
    def sort_batch(self,batch, targets, lengths):
        ...
        return torch.LongTensor(seq_tensor), target_tensor, torch.LongTensor(seq_lengths)
    ...
    def __call__(self, DataLoaderBatch):
        ...
        return self.sort_batch(torch.LongTensor(padded_seqs), torch.LongTensor(tags), torch.LongTensor(lengths))
